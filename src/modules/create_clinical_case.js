        ...
        data: {
            ...
            food_recall: {
                create: {
                    meals: {
                        create: {
                            meals_name: dataFoodRecall.meals_name == undefined ? "" : dataFoodRecall.meals_name,
                            proteins: dataFoodRecall.proteins,
                            carbohydrates: dataFoodRecall.carbohydrates,
                            lipids: dataFoodRecall.lipids,
                            calory: dataFoodRecall.calory,
                            amount: dataFoodRecall.amount,
                        }
                    },
                    total_gram_meal: {
                        create: {
                    ...
                    geral: {
                        create: {
                            amount: dataFoodRecall.amount,
                            energy: dataFoodRecall.energy,
                        }
                    },
                    macronutrients: {
                        create: {
                            protein: dataFoodRecall.protein,
                            cho: dataFoodRecall.cho,
                            lipids: dataFoodRecall.lipids,
                        }
                    },
                    nutrients : {
                        create: {
                            fiber: dataFoodRecall.fiber,
                            sodium: dataFoodRecall.sodium,
                            vitamin_a_retinol: dataFoodRecall.vitamin_a_retinol,
                            vitamin_d_calciferol: dataFoodRecall.vitamin_d_calciferol,
                            vitamin_b1_thiamine: dataFoodRecall.vitamin_b1_thiamine,
                            vitamin_b3_niacin: dataFoodRecall.vitamin_b3_niacin,
                            vitamin_b9_folic_acid: dataFoodRecall.vitamin_b9_folic_acid,
                            iron: dataFoodRecall.iron,
                            potassium: dataFoodRecall.potassium,
                            magnesium: dataFoodRecall.magnesium,
                            total_sugar: dataFoodRecall.total_sugar,
                            cholesterol: dataFoodRecall.cholesterol,
                            polyunsaturated: dataFoodRecall.polyunsaturated,
                            calcium: dataFoodRecall.calcium,
                            selenium: dataFoodRecall.selenium,
                            vitamin_c_ascorbic_acid: dataFoodRecall.vitamin_c_ascorbic_acid,
                            vitamin_e_tocopherol: dataFoodRecall.vitamin_e_tocopherol,
                            vitamin_b2_riboflavin: dataFoodRecall.vitamin_b2_riboflavin,
                            vitamin_b6_pyridoxine: dataFoodRecall.vitamin_b6_pyridoxine,
                            vitamin_b12_cobalamin: dataFoodRecall.vitamin_b12_cobalamin,
                            phosphor: dataFoodRecall.phosphor,
                            zinc: dataFoodRecall.zinc,
                            manganese: dataFoodRecall.manganese,
                            trans: dataFoodRecall.trans,
                            saturated: dataFoodRecall.saturated,
                            monounsaturated: dataFoodRecall.monounsaturated,
                        }
                    }
                }
            },
            food_plan: {
                create: {
                    geral: {
                        create: {
                            amount: dataFoodPlan.amount,
                            energy: dataFoodPlan.energy,
                        }
                    },
                    macronutrients: {
                        create: {
                            protein: dataFoodPlan.protein,
                            cho: dataFoodPlan.cho,
                            lipids: dataFoodPlan.lipids,
                        }
                    },
                    nutrients : {
                        create: {
                            fiber: dataFoodPlan.fiber,
                            sodium: dataFoodPlan.sodium,
                            vitamin_a_retinol: dataFoodPlan.vitamin_a_retinol,
                            vitamin_d_calciferol: dataFoodPlan.vitamin_d_calciferol,
                            vitamin_b1_thiamine: dataFoodPlan.vitamin_b1_thiamine,
                            vitamin_b3_niacin: dataFoodPlan.vitamin_b3_niacin,
                            vitamin_b9_folic_acid: dataFoodPlan.vitamin_b9_folic_acid,
                            iron: dataFoodPlan.iron,
                            potassium: dataFoodPlan.potassium,
                            magnesium: dataFoodPlan.magnesium,
                            total_sugar: dataFoodPlan.total_sugar,
                            cholesterol: dataFoodPlan.cholesterol,
                            polyunsaturated: dataFoodPlan.polyunsaturated,
                            calcium: dataFoodPlan.calcium,
                            selenium: dataFoodPlan.selenium,
                            vitamin_c_ascorbic_acid: dataFoodPlan.vitamin_c_ascorbic_acid,
                            vitamin_e_tocopherol: dataFoodPlan.vitamin_e_tocopherol,
                            vitamin_b2_riboflavin: dataFoodPlan.vitamin_b2_riboflavin,
                            vitamin_b6_pyridoxine: dataFoodPlan.vitamin_b6_pyridoxine,
                            vitamin_b12_cobalamin: dataFoodPlan.vitamin_b12_cobalamin,
                            phosphor: dataFoodPlan.phosphor,
                            zinc: dataFoodPlan.zinc,
                            manganese: dataFoodPlan.manganese,
                            trans: dataFoodPlan.trans,
                            saturated: dataFoodPlan.saturated,
                            monounsaturated: dataFoodPlan.monounsaturated,
                        }
                    }
                }
            }
